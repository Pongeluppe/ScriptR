#
#carregando as bibliotecas que iremos usar no estudo
#
...
library(gridExtra) #para a funçao grid arrange
library(readxl) #ler arquivo csv
...
#Padronizando as variaveis pois estão em escalas diferentes
...
#utilizando o metodo elbow para verificar quantos grupos é melhor utilizar
...
#rodando o modelo nao hierarquico
...
#Imprimir graficos na mesma tela para compara??o
grid.arrange(G1, G2, G3, G4, nrow = 2)

#verificando metodo elbow
